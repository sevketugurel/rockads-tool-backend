...
def create_sample_countries():
    ...
    countries_data = [
        ...
        },
        {
            ...
            "dialect_info": {
                "primary_dialect": "Standard Japanese",
                "accent_characteristics": ["pitch accent", "crisp consonants"],
                "common_phrases": {"how_are_you": "お元気ですか？", "goodbye": "またね", "thank_you": "ありがとうございます"},
                "slang_terms": {"やばい": "awesome/crazy", "マジ": "seriously"},
                "formality_level": "formal",
                "pronunciation_notes": ["Pitch accent varies by region"]
            },
            "cultural_context": {
                "humor_style": "subtle",
                "communication_style": "indirect",
                "color_preferences": ["white", "black", "red"],
                "taboo_topics": ["overly direct criticism", "political jokes"],
                "cultural_values": ["harmony", "craftsmanship", "respect"],
                "marketing_preferences": "quality, detail, reliability",
                "call_to_action_style": "polite suggestion",
                "urgency_indicators": ["今だけ", "数量限定"],
                "trust_building_elements": ["brand heritage", "awards", "precision claims"]
            },
            "preferred_voice_gender": "neutral",
            "speech_rate": 0.95,
            "speech_pitch": 1.05,
            "voice_characteristics": ["polite", "precise"],
            "timezone": "Asia/Tokyo",
            "currency": "JPY",
        ...
        },
        {
            ...
            "dialect_info": {
                ...
                "accent_characteristics": ["tonal", "retroflex consonants"],
                "common_phrases": {"how_are_you": "你好吗？", "goodbye": "再见", "thank_you": "谢谢"},
                "slang_terms": {"厉害": "awesome", "加油": "keep it up"},
                "formality_level": "semi-formal",
                "pronunciation_notes": ["Four main tones, neutral tone"]
            },
            "cultural_context": {
                "humor_style": "situational",
                "communication_style": "contextual",
                "color_preferences": ["red", "gold", "white"],
                "taboo_topics": ["certain political references", "sensitive regions"],
                "cultural_values": ["family", "progress", "respect"],
                "marketing_preferences": "value + practicality, social proof",
                "call_to_action_style": "clear and confident",
                "urgency_indicators": ["限时", "立刻"],
                "trust_building_elements": ["certifications", "KOL reviews"]
            },
            "preferred_voice_gender": "neutral",
            "speech_rate": 1.0,
            "speech_pitch": 1.0,
        ...
        },
        {
            ...
            "dialect_info": {
                "primary_dialect": "Pyongyang dialect",
                "accent_characteristics": ["unreleased finals"],
            ...
            "cultural_context": {
                ...
                "taboo_topics": ["politics", "sensitive commentary"],
                "cultural_values": ["collectivism", "discipline"],
                "marketing_preferences": "n/a",
                "call_to_action_style": "formal",
                "urgency_indicators": [],
        ...
        },
        {
            ...
            "dialect_info": {
                "primary_dialect": "Swiss German",
                "accent_characteristics": ["alemannic"],
                "common_phrases": {"how_are_you": "Wie gaht's?", "goodbye": "Ade", "thank_you": "Merci/ Danke"},
                "slang_terms": {},
            ...
            "cultural_context": {
                ...
                "color_preferences": ["red", "white"],
                "taboo_topics": ["political sensitivities"],
                "cultural_values": ["precision", "neutrality", "quality"],
                "marketing_preferences": "quality, reliability, clarity",
                "call_to_action_style": "polite and clear",
                "urgency_indicators": ["solange Vorrat reicht"],
                "trust_building_elements": ["Swiss quality", "warranty"]
            },
            "preferred_voice_gender": "neutral",
            "speech_rate": 0.98,
            "speech_pitch": 1.0,
            "voice_characteristics": ["clear", "measured"],
